...
import type * as I from '@smogon/calc/data/interface';
// import { Types } from '@smogon/calc/dist/data/types';
import {toID, extend} from '@smogon/calc/util';
...
const SV: TypeChart = extend(true, {}, SS, {
  '???': {Stellar: 1},
  Normal: {Stellar: 1, Cosmic: 1},
  Grass: {Stellar: 1, Cosmic: 0.5},
  Fire: {Stellar: 1, Cosmic: 0},
  Water: {Stellar: 1, Cosmic: 1},
  Electric: {Stellar: 1, Cosmic: 0.5},
  Ice: {Stellar: 1, Cosmic: 2},
  Flying: {Stellar: 1, Cosmic: 1},
  Bug: {Stellar: 1, Cosmic: 2},
  Poison: {Stellar: 1, Cosmic: 2},
  Ground: {Stellar: 1, Cosmic: 0.5},
  Rock: {Stellar: 1, Cosmic: 1},
  Fighting: {Stellar: 1, Cosmic: 0.5},
  Psychic: {Stellar: 1, Cosmic: 1},
  Ghost: {Stellar: 1, Cosmic: 1},
  Dragon: {Stellar: 1, Cosmic: 1},
  Dark: {Stellar: 1, Cosmic: 0.5},
  Steel: {Stellar: 1, Cosmic: 1},
  Fairy: {Stellar: 1, Cosmic: 1},
  Stellar: {
    '???': 1,
		Cosmic: 1,
  },
